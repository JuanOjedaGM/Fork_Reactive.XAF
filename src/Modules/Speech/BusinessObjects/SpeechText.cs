...
namespace Xpand.XAF.Modules.Speech.BusinessObjects {
    ...
    [Appearance("Bold Text",AppearanceItemType.ViewItem, "1=1",TargetItems = nameof(Text),FontStyle = DevExpress.Drawing.DXFontStyle.Bold,Context = SpeechTextBandedListView+","+SpeechTranslation.SpeechTranslationBandedListView,FontColor = "PaleTurquoise")]
